function initMap() {
    var e = { lat: 45.6902361, lng: -92.9358908 },
        t = new google.maps.Map(document.getElementById("map-canvas"), { zoom: 12, center: e, scrollwheel: !1 });
...
$(document).ready(function () {
    ...
    var r = createCalendar({
        ...
        data: {
            ...
            end: new Date("Jan 02, 2022 17:00"),
            address: "8555 Rushseba Trail, Rush City, MN 55069, USA",
            description:
                "The reception address is 1827 Riverside Ave, Minneapolis, MN 55454 (1 hour drive from the ceremony location). We can't wait to see you on our big day. For any queries or issues, please email us at abbyadrian.wedding@gmail.com",
        },
    });
    $("#add-to-cal").html(r),
        $("#rsvp-form").on("submit", function (e) {
            ...
            $("#alert-wrapper").html(alert_markup("info", "<strong>Just a sec!</strong> We are saving your details.")),
                "c347d3c0fc4b168c71f3b542307f47dd" !== MD5($("#invite_code").val())
                    ? $("#alert-wrapper").html(alert_markup("danger", "<strong>Sorry!</strong> Your invite code is incorrect."))
                    : $.post("https://script.google.com/macros/s/AKfycbx4nZvCO4d7FKENTnQphFjoN1WHKWikcdX9wz84jKe-GGr3bOZ_NImCjYEbTwXnRZvy/exec", t)
                          .done(function (e) {
...
var MD5 = function (e) {
    ...
    for (
        ...
        (f = t((s = f), (d = g), (p = h), (m = u), w[i + 0], 7, 3614090360)),
